...
axis(drawable=d, style='xy', ticstyle='out', dominortics=False,
     ...
     xmanual=[['50MB', 50], ['100MB', 100], ['150MB', 150], [
         '200MB', 200], ['250MB', 250], ['300MB', 300], ['350MB', 350]]
     )
...
L.draw(canvas=c, coord=[d.left()+17, d.top()-3], width=5,
       height=5, fontsize=9, skipnext=1, skipspace=55, order=[0, 2, 1])
L_line.draw(canvas=c, coord=[d.left()+14, d.top()-3], width=10,
            height=15, fontsize=9, skipnext=1, skipspace=55, order=[0, 2, 1])
