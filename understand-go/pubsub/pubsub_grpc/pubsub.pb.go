...
var file_pubsub_proto_rawDesc = []byte{
	...
	,
}
...
var file_pubsub_proto_goTypes = []interface{}{
	(*String)(nil), // 0: pubsub_grpc.String
}
var file_pubsub_proto_depIdxs = []int32{
	0, // 0: pubsub_grpc.PubsubService.Publish:input_type -> pubsub_grpc.String
	0, // 1: pubsub_grpc.PubsubService.Subscribe:input_type -> pubsub_grpc.String
	0, // 2: pubsub_grpc.PubsubService.Publish:output_type -> pubsub_grpc.String
	0, // 3: pubsub_grpc.PubsubService.Subscribe:output_type -> pubsub_grpc.String
...
func (c *pubsubServiceClient) Publish(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/pubsub_grpc.PubsubService/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pubsubServiceClient) Subscribe(ctx context.Context, in *String, opts ...grpc.CallOption) (PubsubService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PubsubService_serviceDesc.Streams[0], "/pubsub_grpc.PubsubService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func _PubsubService_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pubsub_grpc.PubsubService/Publish",
	}
...
var _PubsubService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pubsub_grpc.PubsubService",
